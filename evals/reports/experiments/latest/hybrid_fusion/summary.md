...
- Dataset: `v1`
- Commit: `null`
- Date: `2026-08-11T03:10:26.442731700Z`
- Profile: `local`
- Mode: `all`
- RAG Configuration: `{retrievalMode=HYBRID_FUSION, candidatePoolSize=10, finalRankingSize=2147483647, rrfRankConstant=60}`
...
| --- | ---: |
| mrr | 0.87 |
| binaryNdcgAt5 | 0.8483780113082351 |
| binaryNdcgAt10 | 0.8590907108233468 |
| meanFirstRequiredRank | 1.5 |
