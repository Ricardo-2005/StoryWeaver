...
- Dataset: `v1`
- Commit: `null`
- Date: `2026-08-11T03:10:32.616173500Z`
- Profile: `local`
- Mode: `all`
- RAG Configuration: `{retrievalMode=HYBRID_FUSION, candidatePoolSize=30, finalRankingSize=2147483647, rrfRankConstant=60}`
...
| Metric | Result |
| --- | ---: |
| tokenReduction | 73.89% |
| contextPreservationRate | 100.00% |
| qualityPreservingTokenReduction | 73.89% |
